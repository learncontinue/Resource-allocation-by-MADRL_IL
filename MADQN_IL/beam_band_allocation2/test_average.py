...
for i in range(MAX_EPISODES):  # 回合开始前,对环境reset，也就是重置各用户需求到达率和需求矩阵
    ...
    episode_throu_aver[i] = (ep_throu / REPLACE_TARGET_ITER) * 500
    episode_delay_aver[i] = ep_delay / MAX_EP_STEPS
# np.save(r'E:\data\LEO\user_16\throughout\else\average_r', episode_reward_aver)
# np.save(r'E:\data\LEO\user_16\throughout\else\average_th', episode_throu_aver)
# np.save(r'E:\data\LEO\user_16\throughout\else\average_de', episode_delay_aver)
