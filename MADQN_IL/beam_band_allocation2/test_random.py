...
for i in range(MAX_EPISODES):  # 回合开始前,对环境reset，也就是重置各用户需求到达率和需求矩阵
    ...
    episode_throu_rand[i] = (ep_throu/REPLACE_TARGET_ITER)*500
    episode_delay_rand[i] = ep_delay/ MAX_EP_STEPS
    # print('Episode:', i, ' Reward: %.4f' % (ep_reward*2.5))

#np.save(r'E:\data\LEO\user_16\throughout\else\random_r', episode_reward_rand)
#np.save(r'E:\data\LEO\user_16\throughout\else\random_th', episode_throu_rand)
#np.save(r'E:\data\LEO\user_16\throughout\else\random_de', episode_delay_rand)
