...
for i in range(MAX_EPISODES):  # 回合开始前,对环境reset，也就是重置各用户需求到达率和需求矩阵
    ...
    episode_throu_max[i] = (ep_throu/REPLACE_TARGET_ITER)*500
#np.save(r'E:\data\LEO\user_16\throughout\else\max_r', episode_reward_max)
#np.save(r'E:\data\LEO\user_16\throughout\else\max_th', episode_throu_max)
#np.save(r'E:\data\LEO\user_16\throughout\else\max_de', episode_delay_max)
