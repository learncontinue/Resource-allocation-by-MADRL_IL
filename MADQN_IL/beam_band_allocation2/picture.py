...
delay_factor = (-1)*40
# 导入数据集  奖励
episode_reward_rand = np.load(r'E:\data\LEO\user_16\throughout\else\random_r.npy')
episode_reward_aver = np.load(r'E:\data\LEO\user_16\throughout\else\average_r.npy')
episode_reward_max = np.load(r'E:\data\LEO\user_16\throughout\else\max_r.npy')
episode_reward_DQN_test = np.load(r'E:\data\LEO\user_16\throughout\DQN_test\test_r.npy')
# 导入数据集  吞吐量
episode_throu_rand = np.load(r'E:\data\LEO\user_16\throughout\else\random_th.npy')
episode_throu_aver = np.load(r'E:\data\LEO\user_16\throughout\else\average_th.npy')
episode_throu_max = np.load(r'E:\data\LEO\user_16\throughout\else\max_th.npy')
episode_throu_DQN_test = np.load(r'E:\data\LEO\user_16\throughout\DQN_test\test_th.npy')
# 导入数据集  时延
episode_delay_rand = np.load(r'E:\data\LEO\user_16\throughout\else\random_de.npy')
episode_delay_aver = np.load(r'E:\data\LEO\user_16\throughout\else\average_de.npy')
episode_delay_max = np.load(r'E:\data\LEO\user_16\throughout\else\max_de.npy')
episode_delay_DQN_test = np.load(r'E:\data\LEO\user_16\throughout\DQN_test\test_de.npy')
# 训练集仅考虑奖励。
episode_reward_DQN_train = np.load(r'E:\data\LEO\user_16\throughout\DQN_train\data.npy')
...
plt.plot(x, episode_reward_max,label = "最大带宽")
plt.plot(x, episode_reward_DQN_test,label = "DQN")
plt.title('卫星资源分配奖励')
plt.legend()
plt.xlabel('回合数')
plt.ylabel('系统奖励')
...
#plt.plot(x, episode_throu_rand*throughout_factor,label = "随机带宽")
#plt.plot(x, episode_throu_aver*throughout_factor,label = "平均带宽")
#plt.plot(x, episode_throu_max*throughout_factor,label = "最大带宽")
#plt.plot(x, episode_throu_DQN_test*throughout_factor,label = "DQN")
plt.plot(x, episode_throu_rand*throughout_factor,label = "随机波束")
plt.plot(x, episode_throu_aver*throughout_factor,label = "轮询波束")
plt.plot(x, episode_throu_DQN_test*throughout_factor,label = "MADDPG")
...
#plt.plot(x, episode_delay_rand*delay_factor,label = "随机带宽")
#plt.plot(x, episode_delay_aver*delay_factor,label = "平均带宽")
#plt.plot(x, episode_delay_max*delay_factor,label = "最大带宽")
#plt.plot(x, episode_delay_DQN_test*delay_factor,label = "DQN")
